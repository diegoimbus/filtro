package co.moviired.cardManager.conf.database;
...
@EnableJpaRepositories(basePackages = {"co.moviired.cardManager.domain.repository"})
public class CardDbConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(
        ...
        return builder.dataSource(dataSource)
                .packages("co.moviired.cardManager.domain.entity")
