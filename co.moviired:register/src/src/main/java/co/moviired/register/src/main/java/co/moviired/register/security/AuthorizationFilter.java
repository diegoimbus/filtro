package co.moviired.register.security;
...
import static co.moviired.register.helper.ConstantsHelper.CRYPTO_HELPER;
...
public class AuthorizationFilter implements WebFilter {
    ...
    public AuthorizationFilter(@Qualifier(value = CRYPTO_HELPER) @NotNull CryptoHelper pCryptoHelper) {
        super();
