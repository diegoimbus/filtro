...
public enum Product {
    ...
    Product(String pproductName,
            String pcountPlacerHolder,
            String pvaluePlaceHolder,
            String pdisplayPlaceHolder, boolean puseForCalculateTotalSales) {
        this.productName = pproductName;
        this.countPlacerHolder = pcountPlacerHolder;
        this.valuePlaceHolder = pvaluePlaceHolder;
        this.useForCalculateTotalSales = puseForCalculateTotalSales;
        this.displayPlaceHolder = pdisplayPlaceHolder;
    }
