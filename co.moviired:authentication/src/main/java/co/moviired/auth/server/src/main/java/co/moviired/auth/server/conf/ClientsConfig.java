...
import co.moviired.auth.server.helper.GoogleRecaptcha;
import co.moviired.auth.server.properties.*;
...
import static co.moviired.auth.server.helper.ConstantsHelper.REGISTER_API;
