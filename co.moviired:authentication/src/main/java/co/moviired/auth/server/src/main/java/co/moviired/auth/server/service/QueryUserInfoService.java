...
import co.moviired.auth.server.providers.ClientFactory;
import co.moviired.auth.server.providers.IRequest;
import co.moviired.auth.server.providers.IResponse;
import co.moviired.auth.server.providers.mahindra.parser.UserQueryInfoMahindraParser;
    ...
    public Response queryUserInfo(Mono<Request> data, String msisdn) {
        ...
        return data.flatMap(request -> {
            ...
            try {
                ...
                ReactiveConnector provider = clientFactory.getClient(providerType, OperationType.USER_QUERY_INFO);
