...
import static co.moviired.support.util.Constants.ASTERISK;
import static co.moviired.support.util.Constants.REGEX_ALL;
...
public class MahindraDTO implements Serializable {
