...
public class QueryResponse implements Serializable {
    ...
    @ISOFieldDef(fieldNumber = ConstantSwitch.POSITION_38, length = ConstantSwitch.LENGTH_6, mandatory = true)
    private String authorizationResponse;

    @ISOFieldDef(fieldNumber = ConstantSwitch.POSITION_39, length = ConstantSwitch.LENGTH_2, mandatory = true)
    ...
    @ISOFieldDef(fieldNumber = ConstantSwitch.POSITION_60, length = ConstantSwitch.LENGTH_12, mandatory = true)
    private String acquiringInformation;

    @ISOFieldDef(fieldNumber = ConstantSwitch.POSITION_61, length = ConstantSwitch.LENGTH_13, mandatory = true)
    ...
    private String additionalDataReferenceNumber;

    @ISOFieldDef(fieldNumber = ConstantSwitch.POSITION_102, length = ConstantSwitch.LENGTH_18, mandatory = true)
    private String originAccountNumber;

    @ISOFieldDef(fieldNumber = ConstantSwitch.POSITION_103, length = ConstantSwitch.LENGTH_18, mandatory = true)
    private String accountNumber;

    @ISOFieldDef(fieldNumber = ConstantSwitch.POSITION_104, length = ConstantSwitch.LENGTH_18, mandatory = true)
    private String accountIdentification;

    @ISOFieldDef(fieldNumber = ConstantSwitch.POSITION_105, length = ConstantSwitch.LENGTH_25, mandatory = true)
