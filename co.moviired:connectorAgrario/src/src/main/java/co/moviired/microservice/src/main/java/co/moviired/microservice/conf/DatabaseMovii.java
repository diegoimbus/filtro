...
@EnableJpaRepositories(basePackages = {"co.moviired.microservice.domain.jpa.repository"})
public class DatabaseMovii {
    ...
    public DataSource dataSource(Environment env) {
        ...
        confMysqlMovii.setJdbcUrl(env.getProperty("spring.datasource.url"));
        ...
        confMysqlMovii.addDataSourceProperty("useServerPrepStmts", Boolean.TRUE);
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(
        ...
        return builder.dataSource(dataSource)
                .packages("co.moviired.microservice.domain.jpa.entity")
