...
public class MahindraDTO extends IModel {
    ...
    @JsonProperty("PAYEEINSTR")
    private String payeeInstr;

    @JsonProperty("PAYEEPROVIDER")
    private String payeeProvider;

    @JsonProperty("PAYERINSTR")
    private String payerInstr;

    @JsonProperty("PAYERPROVIDER")
    private String payerProvider;

    @JsonProperty("SCH_EXP_ON")
    private String schExpOn;
