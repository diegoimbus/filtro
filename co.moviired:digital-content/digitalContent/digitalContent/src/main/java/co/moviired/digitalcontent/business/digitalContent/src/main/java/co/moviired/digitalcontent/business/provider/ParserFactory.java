...
public class ParserFactory implements Serializable {
    ...
    public ParserFactory(
            ...
            @NotNull PinesServiceMahindraParser pinesServiceMahindraParser,
            @NotNull InactivateCardServiceIntegratorParser inactivateCardServiceIntegratorParser,
            @NotNull ActivateCardServiceMahindraParser activateCardServiceMahindraParser) {
        super();
        this.loginServiceMahindraParser = ploginServiceMahindraParser;
        this.pinesServiceMahindraParser = pinesServiceMahindraParser;
        this.activateCardServiceMahindraParser = activateCardServiceMahindraParser;
        this.inactivateCardServiceIntegratorParser = inactivateCardServiceIntegratorParser;
