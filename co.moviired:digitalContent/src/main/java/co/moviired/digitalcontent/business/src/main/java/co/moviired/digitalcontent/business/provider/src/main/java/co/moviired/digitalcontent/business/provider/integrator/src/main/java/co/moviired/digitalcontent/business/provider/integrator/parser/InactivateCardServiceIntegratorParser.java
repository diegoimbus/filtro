...
public class InactivateCardServiceIntegratorParser implements IParser {
    ...
    public InactivateCardServiceIntegratorParser(@NotNull GlobalProperties globalProperties) {
        super();
    ...
    public final IRequest parseRequest(
        ...
        parametersMeta.put("requestSource", Utils.generateIMEI(data, ip, mhResponseAutenticacion.getAgentcode()));
